    ...
    return (
      <>
        <div style={wrapperStyle} className={wrapperClasses}>
          ...
          <div className={`mt-3 mx-auto w-full ${isMobile ? 'max-w-full px-10' : 'max-w-[-1220px]'} md:ml-[-200px]`}>
          ...
          <div className="mt-3 flex items-center justify-center">
            <div className={`bg-white/80 backdrop-blur-md ${isMobile ? 'rounded-t-xl w-full px-4 py-3' : 'rounded-full px-3 py-1'} md:ml-[-200px] flex gap-2 shadow-sm justify-center`}>
                {[
