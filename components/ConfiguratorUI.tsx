      ...
      <>
        <div style={wrapperStyle} className={wrapperClasses}>
          <button
            ...
            className="absolute top-2 right-2 z-60 w-7 h-7 bg-white rounded-full shadow-md flex items-center justify-center text-xs md:top-3 md:right-[120px]"
          >
            ✕
          </button>
          {/* Gemstone + Render Mode on top */}
          <div className={`mt-3 mx-auto w-full ${isMobile ? 'max-w-full px-4' : 'max-w-[520px]'} md:ml-[80px] md:mr-[200px]`}>
          ...
          <div className="mt-3 flex items-center justify-center">
            <div className={`bg-white/80 backdrop-blur-md ${isMobile ? 'rounded-t-xl w-full px-4 py-3' : 'rounded-full px-3 py-1'} md:ml-[80px] md:mr-[200px] flex gap-2 shadow-sm justify-center`}>
                {[
