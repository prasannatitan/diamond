    ...
    <div className="relative w-full h-screen lux-bg overflow-hidden">
      ...
      {!isDrawerOpen && (
          ...
          <button
            ...
            className="hidden md:flex fixed bottom-6 md:bottom-[80px] md:ml-[30px] right-8 z-60 px-6 py-3 bg-white text-black rounded-full shadow-md hover:shadow-lg transition-shadow font-semibold"
